    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6 class="text-secondary">Do you really want to delete record <b>#{{ isset($order_status) ? ($order_status->id) : '' }}</b>? This process cannot be undone!</h6>
            </div>
            <div class="modal-footer">
                <form action="{{ route('order-status.delete', ['id' => $order_status->id]) }}" method="post">
                    @csrf
                    @method('delete')
