    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6 class="text-secondary">Do you really want to delete record <b>#{{ isset($type_car) ? ($type_car->id) : '' }}</b>? This process cannot be undone!</h6>
            </div>
            <div class="modal-footer">
                <form action="{{ route('type-car.delete', ['id' => $type_car->id]) }}" method="post">
                    @csrf
                    @method('delete')
